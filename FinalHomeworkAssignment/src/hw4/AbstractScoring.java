...
/**
 * An abstract scoring category used to implement the scoring category interface
 * and fill in the commonly used methods with bodies
 * 
 * @author njtucker
 */
public abstract class AbstractScoring implements ScoringCategory {
	...
	public AbstractScoring(String name) {
		this.name = name;
	}
