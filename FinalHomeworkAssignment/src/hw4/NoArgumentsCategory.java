...
/**
 * class for scoring categories that require no arguments 
 * and for methods that are common amongst those categories
 * 
 * @author njtucker
 */
public abstract class NoArgumentsCategory implements ScoringCategory {
	...
	public NoArgumentsCategory(String name, int points) {
		this.name = name;
	}
