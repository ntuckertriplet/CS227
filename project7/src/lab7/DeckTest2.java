...
public class DeckTest2
{
  ...
  public static void main(String[] args)
  {
    ...
    rand[0] = new Card(7, Card.Suit.SPADES);
    rand[1] = new Card(2, Card.Suit.DIAMONDS);
    rand[2] = new Card(8, Card.Suit.CLUBS);
    rand[3] = new Card(7, Card.Suit.DIAMONDS);
    rand[4] = new Card(7, Card.Suit.SPADES);
